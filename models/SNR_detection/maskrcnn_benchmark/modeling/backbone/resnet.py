...
class ResNet_SNR_v2(nn.Module):
    def __init__(self, cfg):
        super(ResNet_SNR_v2, self).__init__()
    ...
    def forward(self, x):
        ...
        for stage_name in self.stages:
            ...
            #     x_IN_1 = self.IN1(x)
            #     x_style_1 = x - x_IN_1
            #     x_style_1_reid_useful, _, _ = self.style_reid_laye1(x_style_1)
            #     x = x_IN_1 + x_style_1_reid_useful
            # elif count == 2:
            #     x_IN_2 = self.IN2(x)
            #     x_style_2 = x - x_IN_2
            #     x_style_2_reid_useful, _, _ = self.style_reid_laye2(x_style_2)
            #     x = x_IN_2 + x_style_2_reid_useful
            # elif count == 3:
            #     x_IN_3 = self.IN3(x)
            #     x_style_3 = x - x_IN_3
            #     x_style_3_reid_useful, _, _ = self.style_reid_laye3(x_style_3)
            #     x = x_IN_3 + x_style_3_reid_useful
